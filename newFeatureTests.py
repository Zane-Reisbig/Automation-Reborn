...
# It works
# I'm going to try it out and see if raising and exception is the best way to do it 
...
# I know that computers these days can recurse a tone, but I also don't want to have people's programs crash due to recursion
